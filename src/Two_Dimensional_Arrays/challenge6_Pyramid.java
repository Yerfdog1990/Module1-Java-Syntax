...
//Fill the array in such a way as to form a pyramid — use '#' to fill the
// cells that make up the pyramid; use ' ' for the background. See the example below.
...
public class challenge6_Pyramid {
