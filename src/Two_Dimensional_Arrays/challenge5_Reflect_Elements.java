...
//Reflect (transpose) the array about the main diagonal (the main diagonal is the set of
// cells for which i == j).
//Display the flipped array on the screen as in the example (each row on a separate line,
// and each element of a row separated by a space).
...
//        •	The program needs to display the elements of the array in accordance
//        with the task conditions.
public class challenge5_Reflect_Elements {
