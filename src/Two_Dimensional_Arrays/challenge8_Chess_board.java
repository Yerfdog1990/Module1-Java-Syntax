...
// Requirements:
//
//Read a number from the keyboard. This will be the dimension of our board
// (the length of a side);
//Initialize the array variable with the appropriate value;
//"Paint" the array to obtain a checkerboard pattern (black cells - '#', white - ' ').
// Start the pattern by putting a '#' in the top left corner of the array;
...
public class challenge8_Chess_board {
