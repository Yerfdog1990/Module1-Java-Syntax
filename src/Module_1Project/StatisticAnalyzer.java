...
public class StatisticAnalyzer {
    ...
    // Method to perform statistical analysis on the encrypted text and a representative sample
    public int statisticalAnalysis(String encryptedText, String representativeText) {
        if (representativeText == null || representativeText.isEmpty()) {
        ...
        return findMostLikelyShift(encryptedText, representativeText);
    }
