...
public class DayClass1 {
    ...
    private DayClass1(String dayName, int ordinal) {
        this.dayName = dayName;
        this.dayNumber = ordinal;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Wednesday is a weekend: " +day.itIsWeekEnd());

        //Get day of the week by ordinal
        DayClass1 dayByOrdinal = DayClass1.findDayByOrdinal(1);
        System.out.println("Day by ordinal 1: " +dayByOrdinal.getDayName());
